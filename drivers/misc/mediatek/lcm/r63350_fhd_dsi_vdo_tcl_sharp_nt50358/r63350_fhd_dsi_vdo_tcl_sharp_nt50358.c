...
static __maybe_unused LCM_DSI_MODE_SWITCH_CMD lcm_switch_mode_cmd;
...
//#define tps65132_write_bytes(a,b) 0
#endif
...
static struct LCM_setting_table lcm_sleep_out_setting[] __maybe_unused = {
    // Sleep Out
	{0x11, 0, {0x00}},
    {REGFLAG_DELAY, 120, {}},
    // Display ON

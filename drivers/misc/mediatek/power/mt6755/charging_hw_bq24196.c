...
kal_bool __weak charging_type_det_done = KAL_TRUE;
...
static int vin_sel_gpio_number = (CUST_GPIO_VIN_SEL | 0x80000000);
...
/* ============================================================ // */
static kal_uint32 __maybe_unused charging_value_to_parameter(const kal_uint32 *parameter, const kal_uint32 array_size,
...
static kal_uint32 charging_parameter_to_value(const kal_uint32 *parameter, const kal_uint32 array_size,
				       const kal_uint32 val)
{
	kal_uint32 i;
...
static kal_uint32 charging_set_cv_voltage(void *data)
{
	...
	static kal_int16 __maybe_unused pre_register_value = -1;
...
{
	kal_uint32 status = STATUS_OK;
	kal_uint32 __maybe_unused array_size;
	kal_uint8 __maybe_unused reg_value;
	kal_uint8 __maybe_unused ret_val = 0;
...
static kal_bool __maybe_unused charging_type_detection_done(void)
{
...
static kal_uint32 charging_set_platform_reset(void *data)
{
	...
	kernel_restart("charging_set_platform_reset\n");
#endif
	return status;
}
...
#if defined(CONFIG_MTK_DUAL_INPUT_CHARGER_SUPPORT)
static void set_diso_otg(bool enable)
{
	g_diso_otg = enable;
}

static void set_vusb_auxadc_irq(bool enable, bool flag)
{
#if !defined(MTK_AUXADC_IRQ_SUPPORT)
...
static void vdc_eint_handler(void)
{
...
static unsigned int charging_set_boost_current_limit(void *data)
{
        ...
        reg_ilim = charging_parameter_to_value(BOOST_CURRENT_LIMIT,
                ARRAY_SIZE(BOOST_CURRENT_LIMIT), current_limit);
	bq24196_set_boost_lim(reg_ilim);
        return ret;
}
...
static kal_uint32(*const charging_func[CHARGING_CMD_NUMBER]) (void *data) = {
	...
	[CHARGING_CMD_SET_VINDPM] =	charging_set_vindpm,
...
*	   None
*/
kal_int32 bq24196_chr_control_interface(CHARGING_CTRL_CMD cmd, void *data);
kal_int32 __weak chr_control_interface(CHARGING_CTRL_CMD cmd, void *data) {
	return bq24196_chr_control_interface(cmd, data);
}
